...
//    NSLog(@"timeSp:%@",timeSp); //时间戳的值
    ...
    if ([_onlineModel.userName isEqualToString:@""] && _onlineModel.userName.length == 0) {
        ...
        if ([_isModification isEqualToString:@"0"]) {
            ...
            //  提交订单
            NSDictionary * dictionary =  @{@"seatTime":_onlineModel.seatTime,@"seatPeople":_onlineModel.seatPeople,@"ownerId":self.ownerId,@"oId":UserId,@"userName":_onlineModel.userName,@"sex":_onlineModel.sex,@"phone":_onlineModel.phone,@"note":_onlineModel.note,@"proIden":PROIDEN};
...
//        NSString *timeSp = [NSString stringWithFormat:@"%ld", (long)[date timeIntervalSince1970]*1000];
        ...
        NSLog(@"seatTime=%@",_onlineModel.seatTime);
        NSDictionary *dictionary = @{@"ownerId":self.ownerId,@"oId":UserId,@"seatId":_seatOrderId,@"seatTime":_onlineModel.seatTime,@"seatPeople":_onlineModel.seatPeople,@"userName":_onlineModel.userName,@"sex":_onlineModel.sex,@"phone":_onlineModel.phone,@"note":_onlineModel.note,@"proIden":PROIDEN};
