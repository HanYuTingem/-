...
- (void)noDataForSmallBannerAndGoodsAndMerchantView
{
    ...
    self.goodsView.hidden = YES;
    self.merchantView.hidden = YES;
    self.HuoDongView.frame = CGRectMake(ORIGIN_X(self.HuoDongView), ORIGIN_Y(self.smallBannersView) + CGRectGetHeight(self.smallBannersView.frame), CGRectGetWidth(self.HuoDongView.frame), CGRectGetHeight(self.HuoDongView.frame));
