...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        UILabel *noLabel = [[UILabel alloc] initWithFrame:CGRectMake(ScreenWidth/2 -[GCUtil widthOfString:@"还没有余额明细哦~" withFont:14]/2   , 78 + 89, [GCUtil widthOfString:@"还没有余额明细哦~" withFont:14], 20)];
