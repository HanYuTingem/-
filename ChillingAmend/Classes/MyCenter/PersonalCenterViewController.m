...
@property (weak, nonatomic) IBOutlet UIButton *myQianBao; //我的钱包
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    // 界面scrollview大小
    [_personalCenterScrollView setContentSize:CGSizeMake(self.view.frame.size.width, 640 - 45 * 2)];
...
- (IBAction)myQianBao:(id)sender {
    ...
    mineWalletViewController *mineWalletView = [[mineWalletViewController alloc] init];
    [self.appDelegate.homeTabBarController hideTabBarAnimated:YES];
    [self.navigationController pushViewController:mineWalletView animated:YES];
