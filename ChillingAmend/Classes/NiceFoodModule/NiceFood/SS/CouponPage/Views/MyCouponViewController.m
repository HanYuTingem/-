...
- (void)DownddateMode{
    ...
    NSDictionary *parameter = @{@"oId":HUserId,@"state":buttonFlagStr,@"page":pageFlagStr,@"rows":@"10",@"proIden":PROIDEN,@"phone":PhoneNumber};
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex{
    if (alertView.tag == 101) {//分享
        if (buttonIndex == 1) {
            NSLog(@"从这里处理跳转的任务");
            NSDictionary *parameter = @{@"oId":HUserId,@"proIden":PROIDEN,@"phone":PhoneNumber};
